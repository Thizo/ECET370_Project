...
public class Project extends JFrame{
	...
	Project()
	{
		...
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);		//close the program when "X" is pressed
		setVisible(true);
	 ...
	 *  If user name exists, logs into home page.
	 *  if user name doesn't exist, shows error message dialog..
	 */
	 ...
	 *  If user name isn't taken, creates new user profile.
	 *  if user name is taken, shows error message dialog.
	 */
	
	public class CreateHandler implements ActionListener {		//actionlistener for the new user button on main menu
		String input; 
		
		public void actionPerformed(ActionEvent e) 
		{
			input = username.getText();		//takes text from the textbox and sets it to the name
	...
	public class Search implements ActionListener		//actionlistener for the search button within profiles
	{
		public void actionPerformed(ActionEvent e) 
		{			
	...
	public class Friends implements ActionListener	//actionlistener for the friends button within profiles
	{
		public void actionPerformed(ActionEvent e) 
		{			
